...
* **13** ada-lk ([දුම්රිය රක්ෂිත පර් චසයක් රුපියල් 100 බැගින් වසරකට බදු දෙයි](https://github.com/nuuuwan/news_lk2/blob/data/articles/a3/a3e70cd7.json))

* **8** daily-mirror-lk ([Telecommunication providers up service charges, VAT](https://github.com/nuuuwan/news_lk2/blob/data/articles/7f/7f7ea8aa.json))
...
* **99** daily-mirror-lk ([Chinese company refuses to budge](https://github.com/nuuuwan/news_lk2/blob/data/articles/ab/ab41ab08.json))
