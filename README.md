...
* **23** ada-derana-lk ([We aren’t supporting all-party govt to receive privileges – Sajith](https://github.com/nuuuwan/news_lk2/blob/data/articles/ce/ce766c82.json))

* **23** news-first-lk ([India only neighbor to help Sri Lanka – Jaishankar](https://github.com/nuuuwan/news_lk2/blob/data/articles/6f/6f563262.json))

* **16** economy-next-com ([Joining all-party cabinet won’t be a ‘system change’: Sri Lanka opp. leader](https://github.com/nuuuwan/news_lk2/blob/data/articles/e4/e442b4c6.json))
...
* **101** ada-derana-lk ([Petroleum Products (Special Provisions) Amendment Bill gazetted](https://github.com/nuuuwan/news_lk2/blob/data/articles/fe/fef38a05.json))
...
* **70** economy-next-com ([Sri Lanka to use US$20mn from Indian credit for animal feed](https://github.com/nuuuwan/news_lk2/blob/data/articles/71/715a57af.json))
...
* **90** economy-next-com ([Reset Sri Lanka reform conference by Advocata Institute](https://github.com/nuuuwan/news_lk2/blob/data/articles/e8/e86a8b16.json))
