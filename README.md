...
*As of 2022-07-06 20:32:25 (LK time)*

![wordcloud animation](wordcloud.gif)

## Last 30 Minutes (2 Articles)

* **2** daily-mirror-lk ([FR challenging presidential pardon given to Sunil Ratnayake fixed for support](https://github.com/nuuuwan/news_lk2/blob/data/articles/4e/4ea9cf0a.json))

## Last Hour (4 Articles)

* **3** daily-mirror-lk ([Some private bus operators indulge in diesel pilferage](https://github.com/nuuuwan/news_lk2/blob/data/articles/69/692977a9.json))

* **1** lankadeepa-lk ([දුම්රිය වර්ජනය අවසන්](https://github.com/nuuuwan/news_lk2/blob/data/articles/1b/1bb470d3.json))

## Last 3 Hours (21 Articles)

* **4** virakesari-lk ([உங்கள் உரிமைகளை வெல்ல போராடுங்கள் - 9 ஆம் திகதி அனைவரும் ஒன்றிணையுங்கள் - சிரேஷ்ட சட்டத்தரணிகள் கோரிக்கை](https://github.com/nuuuwan/news_lk2/blob/data/articles/3b/3b6b3428.json))
...
* **3** lankadeepa-lk ([පණ අදිමින් සිටි ඇතාගේ දළ පොරවකින් ගසා කපාගෙන ගිහින්](https://github.com/nuuuwan/news_lk2/blob/data/articles/a7/a7323e09.json))
...
* **40** virakesari-lk ([நீதியை நாடுவதற்கான சமத்துவத்தன்மையை உறுதிசெய்வது நாட்டின் பொருளாதார ஸ்திரத்தன்மைக்கு இன்றியமையாதது - ஜுலி சங்](https://github.com/nuuuwan/news_lk2/blob/data/articles/7a/7a3c4e4a.json))

* **35** lankadeepa-lk ([මහජන උපයෝගීතා කොමිසමේ සභාපති ඉවත් කරන්නැයි ඉල්ලයි](https://github.com/nuuuwan/news_lk2/blob/data/articles/bd/bd1e9ccf.json))

* **34** daily-mirror-lk ([C.W. Mackie PLC – Scan Product Division launches ‘Recycle for Future Generation’](https://github.com/nuuuwan/news_lk2/blob/data/articles/a0/a0d8b722.json))

* **31** ada-lk ([ප්‍රධානම කඩයිම් තුනට දින නියම වෙයි](https://github.com/nuuuwan/news_lk2/blob/data/articles/f2/f23c4522.json))
...
* **22** ada-derana-lk ([Police bust fake gem racket](https://github.com/nuuuwan/news_lk2/blob/data/articles/09/092fc4e8.json))
...
* **350** virakesari-lk ([மீண்டும் முல்லைத்தீவு கடலை ஆக்கிரமிக்கும் இந்திய இழுவைப்படகுகள் !](https://github.com/nuuuwan/news_lk2/blob/data/articles/8a/8af4b592.json))

* **245** lankadeepa-lk ([හක්මන ඉන්ධන හලක තෙල් මඟඩියක්](https://github.com/nuuuwan/news_lk2/blob/data/articles/e5/e5887e47.json))

* **200** ada-lk ([ඩීසල් නැව ජුලි දෙවැනි සතියේ - පෙට්‍රල් නැව ජුලි අන්තිම සතියේ](https://github.com/nuuuwan/news_lk2/blob/data/articles/f8/f869bbfa.json))

* **189** daily-mirror-lk ([Around 250 Kandakadu detainees arrested](https://github.com/nuuuwan/news_lk2/blob/data/articles/7e/7e550f58.json))
...
* **116** economy-next-com ([Sri Lanka guidance peg edge up despite dollar shortage](https://github.com/nuuuwan/news_lk2/blob/data/articles/da/da47c317.json))
...
## All Time (3,514 Articles)

* **639** virakesari-lk ([யூதர்களுக்கு காலக்கெடுவாக அமைந்துள்ள ஜெரூஸலம்](https://github.com/nuuuwan/news_lk2/blob/data/articles/da/da5d0c4b.json))
...
* **436** ada-lk ([ඉතිහාසයේ පළමු වතාවට පරීක්ෂණ දත්ත රැසක් රැස් කරන බැලුනයක් ගුවනට](https://github.com/nuuuwan/news_lk2/blob/data/articles/d0/d03668f2.json))

* **366** daily-mirror-lk ([Food crisis likely to affect around four to five million people - PM](https://github.com/nuuuwan/news_lk2/blob/data/articles/85/85c52e4e.json))
...
* **285** news-first-lk ([Police OIC appointments: Public Service Commission issues guidelines](https://github.com/nuuuwan/news_lk2/blob/data/articles/ea/eacee196.json))
