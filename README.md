...
*As of 2022-09-02 08:14:58 (LK time)*

![wordcloud animation](wordcloud.gif)

## Last 30 Minutes (2 Articles)

* **2** tamil-mirror-lk ([ஜனாதிபதியினால் 8 செயலணிகள் நியமனம்](https://github.com/nuuuwan/news_lk2/blob/data/articles/c5/c51634fc.json))

## Last Hour (7 Articles)

* **4** tamil-mirror-lk ([இன்றைய வானிலை தொடர்பான அறிவிப்பு](https://github.com/nuuuwan/news_lk2/blob/data/articles/05/0594ce02.json))

* **2** ada-derana-lk ([Low-level atmospheric disturbance gradually moving away](https://github.com/nuuuwan/news_lk2/blob/data/articles/57/577135ef.json))

* **1** daily-mirror-lk ([Indian assets of Lankan man seized in money laundering case](https://github.com/nuuuwan/news_lk2/blob/data/articles/2f/2f2ceb26.json))

## Last 3 Hours (10 Articles)

* **4** tamil-mirror-lk ([இன்றைய வானிலை தொடர்பான அறிவிப்பு](https://github.com/nuuuwan/news_lk2/blob/data/articles/05/0594ce02.json))

* **2** daily-mirror-lk ([Another man shot to death in Middeniya](https://github.com/nuuuwan/news_lk2/blob/data/articles/5c/5c296798.json))
...
* **48** lankadeepa-lk ([දහම් පොලොන්නරු බටහිරට](https://github.com/nuuuwan/news_lk2/blob/data/articles/05/05b240cd.json))

* **36** daily-mirror-lk ([Heavy rains; four sluice gates of Deduru Oya opened: Irrigation Dept.](https://github.com/nuuuwan/news_lk2/blob/data/articles/fb/fb4d26f2.json))

* **27** ada-lk ([පහළ වායුගෝලයේ කැළඹීම තවදුරටත්](https://github.com/nuuuwan/news_lk2/blob/data/articles/16/1684fba3.json))

* **24** tamil-mirror-lk ([நீர் கட்டண திருத்தம் இன்று முதல் நடைமுறை](https://github.com/nuuuwan/news_lk2/blob/data/articles/16/1636e833.json))

* **22** ada-derana-lk ([WFP says three in 10 Sri Lankans are food insecure](https://github.com/nuuuwan/news_lk2/blob/data/articles/fe/feb5f1cc.json))
...
* **10** economy-next-com ([Sri Lanka and IMF reach deal for US$2.9bn program](https://github.com/nuuuwan/news_lk2/blob/data/articles/52/52dd0a5b.json))
...
* **2** d-b-s-jeyaraj-com ([](https://github.com/nuuuwan/news_lk2/blob/data/articles/9e/9e67e678.json))

## Last Week (527 Articles)

* **80** lankadeepa-lk ([ජීවන බර අඩු කිරීමට ජනතාවට සහන සලසනු](https://github.com/nuuuwan/news_lk2/blob/data/articles/d6/d6482c98.json))

* **78** daily-mirror-lk ([Ranjan leaves prison](https://github.com/nuuuwan/news_lk2/blob/data/articles/f1/f10481a7.json))

* **63** ada-lk ([ව්‍යවසායක සහතික පත්‍ර පාඨමාලාවක් හඳුන්වා දෙයි](https://github.com/nuuuwan/news_lk2/blob/data/articles/60/60e206b6.json))
...
* **49** tamil-mirror-lk ([’விருந்தினர்களின் இரவில்’  94 பேர் கைது](https://github.com/nuuuwan/news_lk2/blob/data/articles/f6/f60e5a4b.json))

* **45** ada-derana-lk ([Last Soviet leader Mikhail Gorbachev dies aged 91](https://github.com/nuuuwan/news_lk2/blob/data/articles/71/71faa08d.json))
...
* **50** tamil-mirror-lk ([ஒரே பார்வையில் அன்டனோவ் ஏ.என் 225](https://github.com/nuuuwan/news_lk2/blob/data/articles/ea/ea3da9ff.json))
