...
*As of 2022-08-27 07:34:54 (LK time)*

![wordcloud animation](wordcloud.gif)

## Last 30 Minutes (1 Articles)

* **1** lankadeepa-lk ([පා.මන්ත්‍රී දොලවත්තගේ නිවෙස පහරදුන් හයක් මාට්ටු](https://github.com/nuuuwan/news_lk2/blob/data/articles/be/beee6215.json))

## Last Hour (4 Articles)

* **4** lankadeepa-lk ([හොර හරක් වෑන් රිය අධිබලැති විදුලි කණුවේ ගැටේ](https://github.com/nuuuwan/news_lk2/blob/data/articles/80/80a9eaff.json))
...
* **38** lankadeepa-lk ([අද විටින් විට වැස්ස](https://github.com/nuuuwan/news_lk2/blob/data/articles/70/7016f5da.json))

* **22** ada-lk ([ඔටෝ ඩීසල් නැවක් අද එයි](https://github.com/nuuuwan/news_lk2/blob/data/articles/a3/a32bdfcf.json))

* **21** tamil-mirror-lk ([இலங்கையில் உள்ள இந்தியர்களுக்கு எச்சரிக்கை](https://github.com/nuuuwan/news_lk2/blob/data/articles/ae/aee3b149.json))
...
* **19** ada-derana-lk ([GL warns govt against use of PTA](https://github.com/nuuuwan/news_lk2/blob/data/articles/e6/e674acc9.json))
...
* **271** lankadeepa-lk ([බිත්තරවලට පාලන මිලක්](https://github.com/nuuuwan/news_lk2/blob/data/articles/13/1393262c.json))
...
* **180** tamil-mirror-lk ([முன்னாள் ஜனாதிபதியின் வீட்டுக்கு பலத்த பாதுகாப்பு](https://github.com/nuuuwan/news_lk2/blob/data/articles/48/4828d3ff.json))
...
* **102** economy-next-com ([Sri Lanka Coconut prices continues to increase](https://github.com/nuuuwan/news_lk2/blob/data/articles/8c/8cc118c0.json))
...
## All Time (3,123 Articles)

* **565** lankadeepa-lk ([සමෘද්ධි නිලධාරීන්ට එන්නත නැත්නම් රාජකාරියෙන් ඉවත්වෙනවා](https://github.com/nuuuwan/news_lk2/blob/data/articles/ce/ce124b8f.json))
...
* **392** daily-mirror-lk ([Cardinal says recommendations made by PCoI delayed](https://github.com/nuuuwan/news_lk2/blob/data/articles/d1/d1618b2b.json))

* **377** news-first-lk ([Accusations against Scottish tourist Kayleigh Fraser ‘unjustified’ – SLYOF](https://github.com/nuuuwan/news_lk2/blob/data/articles/0c/0c2545b1.json))

* **330** tamil-mirror-lk ([இன்று இரவு கொழும்பு வருகின்றது மற்றுமொரு கப்பல்](https://github.com/nuuuwan/news_lk2/blob/data/articles/bf/bfd994c3.json))

* **298** ada-derana-lk ([Petroleum Products (Special Provisions) Amendment Bill gazetted](https://github.com/nuuuwan/news_lk2/blob/data/articles/fe/fef38a05.json))

* **213** economy-next-com ([Reset Sri Lanka reform conference by Advocata Institute](https://github.com/nuuuwan/news_lk2/blob/data/articles/e8/e86a8b16.json))
